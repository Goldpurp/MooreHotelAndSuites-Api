...
public interface IGuestCrmService
{
    ...
    Task<GuestPreferencesDto> UpdatePreferencesAsync(string guestId, UpdateGuestPreferencesRequest request, Guid actorId, CancellationToken cancellationToken = default);
